...
- **Lifecycle Policies** - Automated quarantine logic with preview-before-action safety, based on image age and count per repository.
...
Dredge follows a Modular Domain-Driven Design (DDD) architecture. Detailed system diagrams and data flows are available in the [Architecture Documentation](docs/concepts/architecture.md).
